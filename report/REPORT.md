...
- **Nhóm:** Filter là yếu tố quyết định khi embedding model yếu — kéo precision từ 80% → 100% (Huỳnh Văn Nghĩa), 66.8% → 100% (Lưu Lương Vi Nhân). Chi tiết tại bảng so sánh nhóm ở Section 3.
